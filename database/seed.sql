...
-- Módulos Base
INSERT IGNORE INTO modules (name, is_premium) VALUES 
('Facturacion', 0),
('Contabilidad', 1),
('Inventario', 0),
('CRM', 0);
...
INSERT IGNORE INTO document_sequences (document_type, prefix, year, current_number, reset_type) VALUES 
('COT', 'COT', '26', 0, 'YEARLY'),
('FAC', 'FAC', '26', 0, 'YEARLY'),
...
INSERT IGNORE INTO module_license (module_id, is_enabled, activated_at) VALUES 
(1, 1, NOW()),
(2, 0, NULL),
(3, 1, NOW()),
(4, 1, NOW());
